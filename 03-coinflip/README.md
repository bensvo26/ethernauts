...
## Exploit
See [`CoinFlipAttack.sol`](./CoinFlipAttack.sol). The attacker contract recomputes the flip using the same block hash and factor, then calls `flip` with the known answer.
